...
`utilities` contains shared helper functionality for square notation and board visualization. Although small, this simple crate has significantly improved readability and consistency across debugging, test, and development workflows.
