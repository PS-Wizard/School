...
#show: hetvid.with(
  ...
  author: "Group G",
  affiliation: [Members: Nikisha, Rohit, Daehan, Swoyam],
...
Traffic sign classification is a safety-critical perception task because road signs must be recognized quickly and correctly from small visual regions.
