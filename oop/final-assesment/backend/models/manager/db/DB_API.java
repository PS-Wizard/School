...
public class DB_API {
    ...
    public void store(String name, String level, int score1, int score2, int score3, int score4, int score5, int age) {
        String query = String.format("INSERT INTO Competitors (Name, Level, Score1, Score2, Score3, Score4, Score5, Age) VALUES ('%s', '%s', %d, %d, %d, %d, %d, %d)", name, level, score1, score2, score3, score4, score5, age);
