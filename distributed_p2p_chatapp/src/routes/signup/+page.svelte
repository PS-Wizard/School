...
<div class="flex h-[100vh]">
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div class="w-full max-w-md space-y-6">
            <h1 class="text-[4xl~6xl] tracking-tight clash">Sign Up</h1>
            <form class="space-y-4" on:submit={handleSignUp}>
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input
                        ...
                        bind:value={email}
                        required
                        class="w-full rounded-xl border border-neutral-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-black"
                    />
                </div>
                ...
                <!-- submit button -->
                <Button submit overrides="clash w-full text-xl">Sign Up</Button>
            </form>
        </div>
    </div>
